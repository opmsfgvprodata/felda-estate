...
namespace MVC_SYSTEM.Class
{
    public class GetLadang
    {
        ...
        public string GetLadangCostCenter(int ladangid)
        {
            string CostCenter = db.tbl_Ladang.Where(x => x.fld_ID == ladangid).Select(s => s.fld_CostCentre).FirstOrDefault();
            return CostCenter;
        }
        ...
        public string GetLadangCostCenter(int? ladangId)
        {
            return db.tbl_Ladang.Find(ladangId).fld_CostCentre;
        }
    }
}