...
namespace MVC_SYSTEM.Controllers
{
    ...
    public class CheckRollFuncController : Controller
    {
        ...
        public JsonResult _AttendanceFormChange(DateTime SelectedDate, string GroupSelection)
        {
            ...
            Msg = GlobalResEstate.msgChangeDate;
            StatusMsg = "success";
        ...
        public JsonResult _AttendanceFormSave(string NoPkj, string KodHadirCuti, DateTime SelectedDate, short StatusHadir, string GroupSelection)
        {
            ...
            try
            {
                ...
                if (EstateFunction.GetCutiAmMgguMatchDate(NegaraID, SyarikatID, WilayahID, LadangID, SelectedDate, KodHadirCuti, out Msg2))
                {
                    ...
                    if (!CutOfDateStatus)
                    {
                        ...
                        if (StatusHadir == 1)
                        {
                            ...
                            {
                                Msg = GlobalResEstate.msgSaveKept;
                                StatusMsg = "warning";
                                GnrlStatus = false;
                            }
                        }
                        else //tak hadir
                        {
                            ...
                            if (LeaveSelection)
                            {
                                ...
                                {
                                    Msg = GlobalResEstate.msgBalanceLeave;
                                    StatusMsg = "warning";
                                    GnrlStatus = true;
                                }
                            }
            ...
            {
                Msg = GlobalResEstate.msgFailedSave;
                StatusMsg = "danger";
                GnrlStatus = false;
            }
