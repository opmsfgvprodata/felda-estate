...
namespace MVC_SYSTEM.Controllers
{
    ...
    public class CheckRollGMNController : Controller
    {
        ...
        public ActionResult WorkingDetails()
        {
            ...
            if (TotalDayLastKeyIn >= TotalDayLastNeedKeyIn && CheckBlockStatus != null)
            {
                ...
                {
                    dbr.Dispose();
                    return RedirectToAction("CheckRollBlock", "CheckRollGMN", new { msg = 1 });
                }
                else
                {
        ...
        public ActionResult _NeglectedDay()
        {
            ...
            //GMN
            List<SelectListItem> CostCentreHT = new List<SelectListItem>();
            List<SelectListItem> KategoriAktivitiHT = new List<SelectListItem>();

            var getJenisActvtDetails = db.tbl_JenisAktiviti.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_DisabledFlag == 1 && x.fld_Deleted == false).FirstOrDefault();
            CostCentreHT = new SelectList(db.tbl_CostCentre.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID && x.fld_Deleted == false).OrderBy(o => o.fld_CostCentre).Select(s => new SelectListItem { Value = s.fld_CostCentre, Text = s.fld_CostCentre }), "Value", "Text").ToList();
            CostCentreHT.Insert(0, (new SelectListItem { Text = GlobalResEstate.lblChoose, Value = "0" }));
            PilihanPktHT.Insert(0, (new SelectListItem { Text = GlobalResEstate.lblChoose, Value = "0" }));
            ...
            ViewBag.CostCentreHT = CostCentreHT;
        ...
        public ActionResult _NeglectedDay(CustMod_HariTerabai CustMod_HariTerabai)
        {
            ...
            if (string.IsNullOrEmpty(idpengurus) == false && string.IsNullOrEmpty(passpengurus) == false)
            {
                if (CustMod_HariTerabai.JenisChargeHT == "kong")
                {
                    ...
                    //modified by kamalia 23/4/2021
                    //modified by faeza 28.06.2022 - add && x.fld_Deleted == false
                    ...
                    try
                    {
                        ...
                        if (!CutOfDateStatus)
                        {
                            ...
                            if (tbl_Kerjahdrs.Count() != 0)
                            {
                                ...
                                dbr.SaveChanges();
                                EstateFunction.SaveDataKerjaSAP2(dbr, tbl_Kerjas, NegaraID, SyarikatID, WilayahID, LadangID);
                            }
                        }
                        else
                        {
        ...
        public ActionResult _OtherDifficulty(decimal? OtherDifValue, string ManagerID2, string ManagerPassword2)
        {
            ...
            if (string.IsNullOrEmpty(ManagerID2) == false && string.IsNullOrEmpty(ManagerPassword2) == false)
            {
                ...
                var pengurus = db.tblUsers.Where(x => x.fldUserName == ManagerID2 && x.fldUserPassword == ManagerPassword2 && x.fldDeleted == false && x.fldRoleID <= 6).SingleOrDefault();
        ...
        public ActionResult WorkDetail()
        {
            ...
            CostCentre.Insert(0, (new SelectListItem { Text = GlobalResEstate.lblChoose, Value = "0" }));
        ...
        public ActionResult Working(DateTime SelectDate, string SelectionData, int SelectionCategory, string Lejar, byte JnisPkt, string PilihanPkt, string JnisAktvt, string PilihanAktvt, decimal? HrgaKwsnSkr, string KdKwsnSkr, int? AppKwnsSkrLainID, DateTime? AppKwnsSkrLainDT, string CostCentre, List<CustMod_Work> HadirData)
        {
            ...
            if (HadirData != null)
            {
                ...
                if (!CutOfDateStatus)
                {
                    ...
                    var getJenisActvtDetails = db.tbl_UpahAktiviti.Join(db.tbl_JenisAktiviti, j => new { j.fld_NegaraID, j.fld_SyarikatID, j.fld_KodJenisAktvt }, k => new { k.fld_NegaraID, k.fld_SyarikatID, fld_KodJenisAktvt = k.fld_KodJnsAktvt }, (j, k) => new { j.fld_DisabledFlag, j.fld_KodAktvt, j.fld_NegaraID, j.fld_SyarikatID, j.fld_Deleted, k.fld_KodJnsAktvt }).Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_DisabledFlag == 3 && x.fld_Deleted == false).Select(s => s.fld_KodAktvt).ToList();

                    checkkongactvt = SelectionCategory == 1 ? dbr.tbl_Kerja.Where(x => x.fld_Tarikh == SelectDate && x.fld_Kum == SelectionData && getJenisActvtDetails.Contains(x.fld_KodAktvt) && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID).Count()
                    :
                    dbr.tbl_Kerja.Where(x => x.fld_Tarikh == SelectDate && x.fld_Nopkj == SelectionData && getJenisActvtDetails.Contains(x.fld_KodAktvt) && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID).Count();

                    if (getJenisActvtDetails.Contains(PilihanAktvt))
                    {
                        checkrestrickongactvt = SelectionCategory == 1 ? dbr.tbl_Kerja.Where(x => x.fld_Tarikh == SelectDate && x.fld_Kum == SelectionData && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID).Count()
                        :
                    ...
                    if (checksameactvt == 0 && HadirData.Count() != 0 && checkkongactvt == 0 && checkrestrickongactvt == 0)
                    {
                        foreach (var datakerja in HadirData)
                        {
                            if (!EstateFunction.CheckSAPGLMap2(dbr, datakerja.nopkj, PilihanAktvt, NegaraID, SyarikatID, WilayahID, LadangID, false, "-", out GLCode, out PaySheetID))
                            {
                            ...
                            else
                            {
                                ...
                                var getActvtDetail = db.tbl_UpahAktiviti.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_KodAktvt == PilihanAktvt && x.fld_Deleted == false).FirstOrDefault();
                                //var getJenisActvt = db.tbl_UpahAktiviti.Join(db.tbl_JenisAktiviti, j => new { j.fld_NegaraID, j.fld_SyarikatID, fld_KodJenisAktvt = j.fld_KodJenisAktvt }, k => new { k.fld_NegaraID, k.fld_SyarikatID, fld_KodJenisAktvt = k.fld_KodJnsAktvt }, (j, k) => new { j.fld_DisabledFlag, j.fld_KodAktvt, j.fld_NegaraID, j.fld_SyarikatID, j.fld_Deleted, k.fld_KodJnsAktvt }).Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_KodAktvt == PilihanAktvt && x.fld_Deleted == false).FirstOrDefault();
                                var OTHour = datakerja.ot == null ? 0 : datakerja.ot;
                                tbl_KerjaList.Add(new tbl_Kerja() { fld_Nopkj = datakerja.nopkj, fld_Kum = kodkumpulan, fld_Tarikh = SelectDate, fld_KodPkt = PilihanPkt, fld_Amount = datakerja.jumlah, fld_JnsPkt = JnisPkt, fld_JumlahHasil = datakerja.hasil, fld_KadarByr = datakerja.kadar, fld_KodGL = Lejar, fld_KodAktvt = PilihanAktvt, fld_JamOT = OTHour, fld_DataSource = "B", fld_BrtGth = 0, fld_PerBrshGth = 0, fld_Kong = kong, fld_NegaraID = NegaraID, fld_SyarikatID = SyarikatID, fld_WilayahID = WilayahID, fld_LadangID = LadangID, fld_CreatedBy = getuserid, fld_CreatedDT = DTCreated, fld_JnisAktvt = getActvtDetail.fld_KodJenisAktvt, fld_KdhMenuai = datakerja.kdhmnuai, fld_Bonus = datakerja.bonus, fld_Unit = getActvtDetail.fld_Unit, fld_Quality = datakerja.kualiti, fld_HrgaKwsnSkar = HrgaKwsnSkr, fld_KodKwsnSkar = KdKwsnSkr, fld_ApprovalKwsnSkarDT = AppKwnsSkrLainDT, fld_ApprovalKwsnSkarLainBy = AppKwnsSkrLainID, fld_OverallAmount = datakerja.jumlahOA });
                                breakprocess = false;
                            }
                        }
                        if (!breakprocess)
                        {
                            ...
                            dbr.SaveChanges();
                            EstateFunction.SaveDataKerjaSAP2(dbr, tbl_KerjaList, NegaraID, SyarikatID, WilayahID, LadangID);
                            msg = GlobalResEstate.msgAdd;
                            statusmsg = "success";
                        }
                    }
                    else
                    {
                        ...
                        else if (checkrestrickongactvt >= 1)
                        {
                            msg = GlobalResEstate.msgKodAkvtNAllow;
                            statusmsg = "warning";
                        }
                        else
                        {
        ...
        public ActionResult ActivityCodeDetails(string ActivityType, string CostCentre)
        {
            int? NegaraID, SyarikatID, WilayahID, LadangID = 0;
            int? getuserid = getidentity.ID(User.Identity.Name);

            GetNSWL.GetData(out NegaraID, out SyarikatID, out WilayahID, out LadangID, getuserid, User.Identity.Name);
            List<tbl_UpahAktiviti> CodeActivt = new List<tbl_UpahAktiviti>();
            tbl_CostCentre GetCostCentreDetail = new tbl_CostCentre();
            if (ActivityType == "05")
            {
                var getJenisActvtDetails = db.tbl_JenisAktiviti.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_DisabledFlag == 3 && x.fld_Deleted == false).Select(s => s.fld_KodJnsAktvt).ToList();
                GetCostCentreDetail = db.tbl_CostCentre.Where(x => x.fld_CostCentre == CostCentre && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID).FirstOrDefault();
                CodeActivt = db.tbl_UpahAktiviti.Where(x => x.fld_Deleted == false && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_KategoriAktvt == GetCostCentreDetail.fld_KodKtgri && getJenisActvtDetails.Contains(x.fld_KodJenisAktvt)).OrderBy(o => o.fld_KodAktvt).ToList();
            }
            else
            {
                GetCostCentreDetail = db.tbl_CostCentre.Where(x => x.fld_CostCentre == CostCentre && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID).FirstOrDefault();
                CodeActivt = db.tbl_UpahAktiviti.Where(x => x.fld_Deleted == false && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_KategoriAktvt == GetCostCentreDetail.fld_KodKtgri).OrderBy(o => o.fld_KodAktvt).ToList();
            }

            ViewBag.ActvtType = db.tbl_KategoriAktiviti.Where(x => x.fld_Deleted == false && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_KodKategori == GetCostCentreDetail.fld_KodKtgri).Select(s => s.fld_Kategori).FirstOrDefault();
        ...
        public JsonResult GetAktvt(string JnisAktvt)
        {
            ...
            db.Dispose();
            return Json(new { PilihAktiviti, AktivitiToolTip });
        }
        ...
        public JsonResult GetPktAtvt(string CostCentre)
        {
            int? NegaraID, SyarikatID, WilayahID, LadangID = 0;
            int? getuserid = getidentity.ID(User.Identity.Name);
            string host, catalog, user, pass = "";
            ...
            var GetCostCentreDetail = db.tbl_CostCentre.Where(x => x.fld_CostCentre == CostCentre && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID).FirstOrDefault();

            PilihPeringkat = new SelectList(dbr.tbl_PktUtamaOthr.Where(x => x.fld_CostCentreCode == CostCentre && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID && x.fld_Deleted == false).OrderBy(o => o.fld_PktCode).Select(s => new SelectListItem { Value = s.fld_PktCode, Text = s.fld_PktCode + " - " + s.fld_PktCodeDesc }), "Value", "Text").ToList();
            PilihPeringkat.Insert(0, (new SelectListItem { Text = GlobalResEstate.lblChoose, Value = "0" }));
            PilihAktiviti = new SelectList(db.tbl_UpahAktiviti.Where(x => x.fld_KategoriAktvt == GetCostCentreDetail.fld_KodKtgri && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_Deleted == false).OrderBy(o => o.fld_KodAktvt).Select(s => new SelectListItem { Value = s.fld_KodAktvt, Text = s.fld_KodAktvt }), "Value", "Text").ToList();
            PilihAktiviti.Insert(0, (new SelectListItem { Text = GlobalResEstate.lblChoose, Value = "0" }));
            var AktivitiToolTip = db.tbl_UpahAktiviti.Where(x => x.fld_KategoriAktvt == GetCostCentreDetail.fld_KodKtgri && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_Deleted == false).OrderBy(o => o.fld_KodAktvt).Select(s => new { Label = s.fld_KodAktvt + " - " + s.fld_Desc + " - RM" + s.fld_Harga }).ToList();
            return Json(new { PilihPeringkat, PilihAktiviti, AktivitiToolTip });
        }

        public JsonResult GetPktAtvt2(string CostCentre)
        {
            int? NegaraID, SyarikatID, WilayahID, LadangID = 0;
            int? getuserid = getidentity.ID(User.Identity.Name);
            string host, catalog, user, pass = "";
            ...
            PilihPeringkat = new SelectList(dbr.tbl_PktUtamaOthr.Where(x => x.fld_CostCentreCode == CostCentre && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID).OrderBy(o => o.fld_PktCode).Select(s => new SelectListItem { Value = s.fld_PktCode, Text = s.fld_PktCode + " - " + s.fld_PktCodeDesc }), "Value", "Text").ToList();
            PilihPeringkat.Insert(0, (new SelectListItem { Text = GlobalResEstate.lblChoose, Value = "0" }));
            PilihAktiviti = new SelectList(db.tbl_UpahAktiviti.Where(x => x.fld_KategoriAktvt == GetCostCentreDetail.fld_KodKtgri && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && getJenisActvtDetails.Contains(x.fld_KodJenisAktvt)).OrderBy(o => o.fld_KodAktvt).Select(s => new SelectListItem { Value = s.fld_KodAktvt, Text = s.fld_KodAktvt }), "Value", "Text").ToList();
            PilihAktiviti.Insert(0, (new SelectListItem { Text = GlobalResEstate.lblChoose, Value = "0" }));

            var AktivitiToolTip = db.tbl_UpahAktiviti.Where(x => x.fld_KategoriAktvt == GetCostCentreDetail.fld_KodKtgri && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && getJenisActvtDetails.Contains(x.fld_KodJenisAktvt)).OrderBy(o => o.fld_KodAktvt).Select(s => new { Label = s.fld_KodAktvt + " - " + s.fld_Desc + " - RM" + s.fld_Harga }).ToList();
        ...
        public JsonResult GetForm(int SelectionCategory, string SelectionData, string PilihanPkt, string KodAktvt, DateTime SelectDate)
        {
            int? NegaraID, SyarikatID, WilayahID, LadangID = 0;
            int? getuserid = getidentity.ID(User.Identity.Name);
            string host, catalog, user, pass = "";
            ...
            var tbl_UpahAktiviti = db.tbl_UpahAktiviti.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_KodAktvt == KodAktvt).FirstOrDefault();
            var tbl_JenisAktiviti = db.tbl_JenisAktiviti
                .Join(db.tbl_UpahAktiviti
                ...
                .Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_KodJnsAktvt == tbl_UpahAktiviti.fld_KodJenisAktvt && x.fld_KodAktvt == KodAktvt && x.fld_Deleted == false).FirstOrDefault();
            ...
            {
                kadarharga = tbl_JenisAktiviti.fld_KdhByr == "B" ? tbl_JenisAktiviti.fld_Harga : 0;
            }
            else
            {
                kadarharga1 = tbl_JenisAktiviti.fld_KdhByr == "B" ? tbl_JenisAktiviti.fld_Harga : 0;
                //modified by faeza 28.06.2022 - add && x.fld_Deleted == false
                var getgajiminima = db.tbl_GajiMinimaLdg.Where(x => x.fld_LadangID == LadangID && x.fld_Deleted == false).FirstOrDefault();
