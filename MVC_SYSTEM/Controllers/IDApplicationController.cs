    ...
    public class IDApplicationController : Controller
    {
        ...
        public JsonResult GetBatchNo(string kodladang, string kdprmhnan)
        {
            ...
            if (getbatchno == null)
            {
                ...
                dbC.SaveChanges();
                convertint = 1;
                genbatchno = kdprmhnan + kodladang + "userid" + convertint;
            }
            else
            {
                convertint = getbatchno.fld_BatchRunNo.Value;
                genbatchno = kdprmhnan + kodladang + "userid" + convertint;
        ...
        public JsonResult SearchBatch(int batchno, string kodladang, string kdprmhnan)
        {
            ...
            {
                statussbmt = GlobalResEstate.msgAppSubmit;
            }
            else
            {
                statussbmt = GlobalResEstate.msgAppNotSubmit;
            }
            ...
            if (getNotiStatus != null)
            {
                msg = GlobalResEstate.msgDataFoundnNChage;
                statusmsg = "success";
                status = true;
            }
            else
                                                                      ...
                                                                      //string PositionList)
        {
            ...
            try
            {
                ...
                msg = GlobalResEstate.msgDataEnter;
                statusmsg = "success";
                status = true;
            }
            catch (Exception ex)
        ...
        public ActionResult Edit(int fldID, string fldUserFullName, string fldNoKP, string PositionList, string fldUserShortName, string fldUserEmail, int BatchID)
        {
            ...
            try
            {
                ...
                msg = GlobalResEstate.msgDataUpdate;
                statusmsg = "success";
                status = true;
            }
            catch (Exception ex)
