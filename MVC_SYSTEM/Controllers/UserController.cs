    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Create(MasterModels.tblUser tblUser)
        {
            ...
            try
            {
                ...
                if (checkdata == null)
                {
                    ...
                    return Json(new { success = true, msg = GlobalResEstate.msgAdd, status = "success", checkingdata = "0", method = "1", getid = getid, data1 = tblUser.fldUserName, data2 = tblUser.fldUserName, data3 = "" });
                }
                else
                {
                    return Json(new { success = true, msg = GlobalResEstate.msgUserExits, status = "warning", checkingdata = "1" });
                }
            ...
            catch (Exception ex)
            {
                ...
                return Json(new { success = true, msg = GlobalResEstate.msgErrorIT, status = "danger", checkingdata = "1" });
            }
            //}
            //else
            //{
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            try
            {
                ...
                if (tblUser == null)
                {
                    return Json(new { success = true, msg = GlobalResEstate.msgDelete3, status = "success", checkingdata = "0", method = "1", getid = "", data1 = "", data2 = "" });
                }
                else
                {
                    bool status = true;
