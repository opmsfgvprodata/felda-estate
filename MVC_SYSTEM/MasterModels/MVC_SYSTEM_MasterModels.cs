namespace MVC_SYSTEM.MasterModels
{
    ...
    public partial class MVC_SYSTEM_MasterModels : DbContext
    {
        ...
        public virtual DbSet<tbl_CutiPilihanHistory> tbl_CutiPilihanHistory { get; set; }
        ...
        //farahin - master data log
        public virtual DbSet<tbl_SAPLog> tbl_sapLog { get; set; }

        //farahin - sap function batch run no
        public virtual DbSet<tbl_BatchRunRefNo> tbl_BatchRunRefNo { get; set; }

        //farahin - data IO List
        ...
        {
            //Database.SetInitializer<MVC_SYSTEM_MasterModels>(null);
