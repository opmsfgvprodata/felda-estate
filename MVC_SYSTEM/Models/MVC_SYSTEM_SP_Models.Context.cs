...
namespace MVC_SYSTEM.Models
{
    ...
    public partial class MVC_SYSTEM_SP_Models : DbContext
    {
        ...
        {
            ((IObjectContextAdapter)this).ObjectContext.CommandTimeout = 0; //modified 08.02.2021
        }
        ...
        public static MVC_SYSTEM_SP_Models ConnectToSqlServer(string host, string catalog, string user, string pass)
        {
            ...
            sqlBuilder.ConnectTimeout = 0; ; //modified 08.02.2021 - changed 100 to 0
        ...
        public virtual IEnumerable<sp_DashAllKerakyatan_Result> sp_DashAllKerakyatan(Nullable<int> syarikatID, Nullable<int> ladangID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_DashAllKerakyatan_Result>("sp_DashAllKerakyatan", syarikatIDParameter, ladangIDParameter);
        }

        public virtual IEnumerable<sp_DashPermitExpired_Result> sp_DashPermitExpired(Nullable<int> syarikatID, Nullable<int> ladangID)
        {
            var syarikatIDParameter = syarikatID.HasValue ?
                new ObjectParameter("SyarikatID", syarikatID) :
                new ObjectParameter("SyarikatID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_DashPermitExpired_Result>("sp_DashPermitExpired", syarikatIDParameter, ladangIDParameter);
        }

        public virtual IEnumerable<sp_DashStatusAkaun_Result> sp_DashStatusAkaun(Nullable<int> syarikatID, Nullable<int> year, Nullable<int> month, Nullable<int> wilayah, Nullable<int> ladangID)
        {
            var syarikatIDParameter = syarikatID.HasValue ?
                new ObjectParameter("SyarikatID", syarikatID) :
                new ObjectParameter("SyarikatID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_DashStatusAkaun_Result>("sp_DashStatusAkaun", syarikatIDParameter, yearParameter, monthParameter, wilayahParameter, ladangIDParameter);
        }

        public virtual IEnumerable<sp_DatatableKerakyatan_Result> sp_DatatableKerakyatan(Nullable<int> syarikatID, Nullable<int> ladangID, string kerakyatan)
        {
            var syarikatIDParameter = syarikatID.HasValue ?
                new ObjectParameter("SyarikatID", syarikatID) :
                new ObjectParameter("SyarikatID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_DatatableKerakyatan_Result>("sp_DatatableKerakyatan", syarikatIDParameter, ladangIDParameter, kerakyatanParameter);
        }

        public virtual IEnumerable<sp_DatatablePermitExpired_Result> sp_DatatablePermitExpired(Nullable<int> syarikatID, Nullable<int> wilayah, Nullable<int> type, Nullable<int> ladangID)
        {
            var syarikatIDParameter = syarikatID.HasValue ?
                new ObjectParameter("SyarikatID", syarikatID) :
                new ObjectParameter("SyarikatID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_DatatablePermitExpired_Result>("sp_DatatablePermitExpired", syarikatIDParameter, wilayahParameter, typeParameter, ladangIDParameter);
        }
        ...
        public virtual int sp_RptGajiMinima(string dataSource, string databaseName, Nullable<int> negaraID, Nullable<int> syarikatID, Nullable<int> wilayahID, Nullable<int> ladangID, string levelAccess, Nullable<int> month, Nullable<int> year, Nullable<int> userID, Nullable<short> selectionCategory)
        {
            var dataSourceParameter = dataSource != null ?
                new ObjectParameter("DataSource", dataSource) :
                new ObjectParameter("DataSource", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_RptGajiMinima", dataSourceParameter, databaseNameParameter, negaraIDParameter, syarikatIDParameter, wilayahIDParameter, ladangIDParameter, levelAccessParameter, monthParameter, yearParameter, userIDParameter, selectionCategoryParameter);
        }
        ...
        public virtual int sp_RptMasterDataPkj(string dataSource, string databaseName, Nullable<int> negaraID, Nullable<int> syarikatID, Nullable<int> wilayahID, Nullable<int> ladangID, string levelAccess, string kdrytan, string statusAktif, string kategoriPkj, Nullable<int> userID, Nullable<short> selectionCategory)
        {
            var dataSourceParameter = dataSource != null ?
                new ObjectParameter("DataSource", dataSource) :
                new ObjectParameter("DataSource", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_RptMasterDataPkj", dataSourceParameter, databaseNameParameter, negaraIDParameter, syarikatIDParameter, wilayahIDParameter, ladangIDParameter, levelAccessParameter, kdrytanParameter, statusAktifParameter, kategoriPkjParameter, userIDParameter, selectionCategoryParameter);
        }

        public virtual int sp_RptPaymentMode(string dataSource, string databaseName, Nullable<int> negaraID, Nullable<int> syarikatID, Nullable<int> wilayahID, Nullable<int> ladangID, Nullable<int> year, Nullable<int> month, Nullable<int> userID)
        {
            var dataSourceParameter = dataSource != null ?
                new ObjectParameter("DataSource", dataSource) :
                new ObjectParameter("DataSource", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_RptPaymentMode", dataSourceParameter, databaseNameParameter, negaraIDParameter, syarikatIDParameter, wilayahIDParameter, ladangIDParameter, yearParameter, monthParameter, userIDParameter);
        }
        ...
        public virtual int sp_YieldBracketTableSum(Nullable<int> negaraID, Nullable<int> syarikatID, Nullable<int> wilayahID, Nullable<int> ladangID, Nullable<int> jnsPkt)
        {
            var negaraIDParameter = negaraID.HasValue ?
                new ObjectParameter("NegaraID", negaraID) :
                new ObjectParameter("NegaraID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_YieldBracketTableSum", negaraIDParameter, syarikatIDParameter, wilayahIDParameter, ladangIDParameter, jnsPktParameter);
        }

        public virtual int spTest(Nullable<int> negaraID, Nullable<int> syarikatID, Nullable<int> wilayahID, Nullable<int> ladangID)
        {
            var negaraIDParameter = negaraID.HasValue ?
                new ObjectParameter("NegaraID", negaraID) :
                new ObjectParameter("NegaraID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spTest", negaraIDParameter, syarikatIDParameter, wilayahIDParameter, ladangIDParameter);
        }

        public virtual IEnumerable<sp_DashTransactionListing_Result> sp_DashTransactionListing(Nullable<int> syarikatID, Nullable<int> ladangID, Nullable<int> year)
        {
            var syarikatIDParameter = syarikatID.HasValue ?
                new ObjectParameter("SyarikatID", syarikatID) :
                new ObjectParameter("SyarikatID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_DashTransactionListing_Result>("sp_DashTransactionListing", syarikatIDParameter, ladangIDParameter, yearParameter);
        }

        public virtual IEnumerable<sp_AuditStatusAkaun_Result> sp_AuditStatusAkaun(Nullable<int> syarikatID, Nullable<int> year, Nullable<int> wilayah, Nullable<int> ladangID)
        {
            var syarikatIDParameter = syarikatID.HasValue ?
                new ObjectParameter("SyarikatID", syarikatID) :
                new ObjectParameter("SyarikatID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_AuditStatusAkaun_Result>("sp_AuditStatusAkaun", syarikatIDParameter, yearParameter, wilayahParameter, ladangIDParameter);
        }
    }
}
