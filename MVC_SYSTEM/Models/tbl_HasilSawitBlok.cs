...
namespace MVC_SYSTEM.Models
{
    ...
    public partial class tbl_HasilSawitBlokModelViewCreate
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Guid fld_ID { get; set; }
        ...
        [Required(ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgModelValidation")]
        //[RegularExpression("^\\d+(?:\\.\\d{1,3})?$", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "MsgModelValidationAreaExceedRange")]
        //[Remote("IsBlokAreaWithinRange", "WorkerInfo", AdditionalFields = "fld_KodBlok", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "MsgModelValidationAreaExceedRange")]
        [Column(TypeName = "numeric")]
        public decimal? fld_LuasHektar { get; set; }
    ...
    public partial class tbl_HasilSawitBlokModelViewEdit
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Guid fld_ID { get; set; }
