...
namespace MVC_SYSTEM.Models
{
    ...
    public partial class tbl_HasilSawitSubPktModelViewCreate
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Guid fld_ID { get; set; }
        ...
        //[Remote("IsSubPktAreaWithinRange", "WorkerInfo", AdditionalFields = "fld_KodSubPeringkat", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "MsgModelValidationAreaExceedRange")]
        [Column(TypeName = "numeric")]
        public decimal? fld_LuasHektar { get; set; }
    ...
    public partial class tbl_HasilSawitSubPktModelViewEdit
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public Guid fld_ID { get; set; }
