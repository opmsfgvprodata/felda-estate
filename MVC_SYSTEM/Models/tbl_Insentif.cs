...
namespace MVC_SYSTEM.Models
{
    ...
    public partial class tbl_InsentifViewModelCreate
    {
        ...
        [Required(ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgModelValidation")]
        [RegularExpression("^\\d+(?:\\.\\d{1,2})?$", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "msgNumberModelValidation")]
        [Remote("IsIncentiveWithinRange", "WorkerInfo", AdditionalFields = "fld_KodInsentif", ErrorMessageResourceType = typeof(GlobalResEstate), ErrorMessageResourceName = "MsgModelValidationIncentiveExceedRange")]
